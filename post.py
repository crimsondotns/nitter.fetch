...
def log_http_status(status: int, username: str, context: str = ""):
    if status == 200:
        common.log_success(f"HTTP \033[92m200\033[0m | Successfully fetched posts", context=context)
    elif status == 403:
        ...
        common.log_error(f"HTTP \033[91m{status}\033[0m | Error fetching posts", context=context)
